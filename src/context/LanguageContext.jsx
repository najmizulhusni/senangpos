...
const translations = {
  en: {
    ...
    locations: 'Locations',
    weeklySchedule: 'Weekly Location Schedule',
    weeklyScheduleDesc: 'Set your pasar tani location for each day of the week',
    locationsSaved: 'Locations saved!',
    saveSchedule: 'Save Schedule',
    locationNote: 'Your POS menu will automatically show today\'s location based on this schedule.',
    monday: 'Monday',
    tuesday: 'Tuesday',
    wednesday: 'Wednesday',
    thursday: 'Thursday',
  ...
  ms: {
    ...
    locations: 'Lokasi',
    weeklySchedule: 'Jadual Lokasi Mingguan',
    weeklyScheduleDesc: 'Tetapkan lokasi pasar tani anda untuk setiap hari dalam seminggu',
    locationsSaved: 'Lokasi disimpan!',
    saveSchedule: 'Simpan Jadual',
    locationNote: 'Menu POS anda akan memaparkan lokasi hari ini secara automatik berdasarkan jadual ini.',
    monday: 'Isnin',
    tuesday: 'Selasa',
    wednesday: 'Rabu',
    thursday: 'Khamis',
