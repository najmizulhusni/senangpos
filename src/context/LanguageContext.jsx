...
const translations = {
  en: {
    ...
    supportDesc: 'Send us a message via WhatsApp if you have any problems',
    subject: 'Subject',
  ...
  ms: {
    ...
    supportDesc: 'Hantar mesej melalui WhatsApp jika ada masalah',
    subject: 'Subjek',
    selectSubject: 'Pilih subjek',
    bugReport: 'Laporan Bug',
    featureRequest: 'Cadangan Ciri',
    paymentIssue: 'Masalah Pembayaran',
    accountHelp: 'Bantuan Akaun',
    other: 'Lain-lain',
    message: 'Mesej',
